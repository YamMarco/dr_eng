...
### Community 83 - "confirmDiscard"
Cohesion: 0.50
Nodes (4): confirmDiscard(), guardedExit(), guardedFinish(), guardedFinishAndContinue()

## Knowledge Gaps
- **496 isolated node(s):** `LessonScore`, `LessonSession`, `MarkAllCategory`, `MarkAllScreen`, `MarkWordScreen` (+491 more)
