...
## Corpus Check
- 134 files · ~83,504 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 844 nodes · 1018 edges · 81 communities (67 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02753794`
...
### Community 5 - "lessons/+page.svelte"
Cohesion: 0.07
Nodes (10): EditStore, ScreenPath, DebugStore, lessonProgress, LessonProgressStore, persist(), ProgressMap, PALETTE (+2 more)
...
### Community 63 - "Section 3 · Eye Catchers · מספרים"
Cohesion: 0.25
...
### Community 67 - "Section 4 · Eye Catchers · שמות"
Cohesion: 0.25
...
### Community 68 - "Section 1 · לפענח את השאלה"
Cohesion: 0.29
...
## Knowledge Gaps
- **468 isolated node(s):** `Detach`, `ScreenPath`, `LessonScore`, `MarkAllScreen`, `MarkWordScreen` (+463 more)
...
- **What connects `Detach`, `ScreenPath`, `LessonScore` to the rest of the system?**
