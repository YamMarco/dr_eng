...
## Corpus Check
- 133 files · ~82,825 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 837 nodes · 1010 edges · 78 communities (63 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `66a728e3`
...
Cohesion: 0.09
Nodes (17): ESCAPE, MarkAllScreen, MarkWordScreen, McqScreen, PassageQuizQuestion, PassageQuizScreen, PrefaceScreen, QuestionPreviewScreen (+9 more)
...
Cohesion: 0.10
Nodes (8): EditStore, dictionaries, I18n, Language, ar, Dictionary, DictionaryOverride, he
...
## Knowledge Gaps
- **467 isolated node(s):** `LessonScore`, `MarkAllScreen`, `MarkWordScreen`, `McqScreen`, `PassageQuizQuestion` (+462 more)
...
- **What connects `LessonScore`, `MarkAllScreen`, `MarkWordScreen` to the rest of the system?**
