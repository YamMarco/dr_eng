...
## Corpus Check
- 261 files · ~497,096 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1423 nodes · 1976 edges · 201 communities (165 shown, 36 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `705acf49`
...
Cohesion: 0.12
Nodes (6): screenList(), EditModelLike, ScreenPath, blankScreen(), LessonScreen, QuizPart
...
Cohesion: 0.13
Nodes (6): reducedMotion, formattedDate, i(), minutes, questionCount, ./$types
...
### Community 123 - "module-c-audit_23c616f8.md"
Cohesion: 0.33
Nodes (5): Fixed on 2026-09-19, Part A: vocabulary (c-2), Part B: reading (c-1), Part C: writing (c-3), Still open

## Knowledge Gaps
- **651 isolated node(s):** `gitignorePath`, `name`, `private`, `version`, `type` (+646 more)
...
- **Why does `EditModel` connect `EditModel` to `editModel.svelte.ts`, `LessonScreen`, `content/index.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `LessonScreen` connect `LessonScreen` to `SlideStage.svelte`, `ExamEditModel`, `editModel.svelte.ts`, `registry.ts`, `lesson-screens/types.ts`, `validate.ts`, `content/index.ts`?**
