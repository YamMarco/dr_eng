...
## Corpus Check
- 153 files · ~122,645 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1062 nodes · 1377 edges · 96 communities (81 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f8e6b35`
...
Cohesion: 0.14
Nodes (8): lessonProgress, LessonProgressStore, persist(), ProgressMap, LocationMap, moduleLocation, ModuleLocationStore, persist()
...
## Knowledge Gaps
- **548 isolated node(s):** `Model`, `Where things live (`front/src/`)`, `Authoring a lesson`, `Screen types`, `Text formatting syntax` (+543 more)
