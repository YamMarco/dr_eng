...
## Corpus Check
- 153 files · ~122,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1063 nodes · 1376 edges · 95 communities (79 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `464477f7`
...
Cohesion: 0.06
Nodes (22): CurriculumModule, CurriculumSection, EXAM_MINUTES, getModule(), getUnitGroup(), modules, textSection, UnitGroup (+14 more)
...
Cohesion: 0.07
Nodes (21): post(), saveLessonContent(), saveSection(), storedKey(), EditStore, errorCount, hint, issues (+13 more)
...
Cohesion: 0.05
Nodes (26): DebugStore, currentPath, currentScreen, direction, editHref, footerDisabled, footerLabel, isLastRound (+18 more)
...
Cohesion: 0.16
Nodes (6): SECTION_IDS, i(), SCREEN_TYPE_GROUPS, SCREEN_TYPES, issuesByNode(), getLessonsBySection()
...
## Knowledge Gaps
- **549 isolated node(s):** `checked`, `allFilled`, `minorIssues`, `punctuationOk`, `combinedText` (+544 more)
...
- **Why does `EditModel` connect `EditModel` to `editModel.svelte.ts`, `content/index.ts`, `ScreenPath`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `checked`, `allFilled`, `minorIssues` to the rest of the system?**
