# Graph Report - dr_eng  (2026-09-19)

## Corpus Check
- 152 files · ~122,664 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1060 nodes · 1386 edges · 97 communities (81 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3abf3c43`
...
Cohesion: 0.10
Nodes (19): ClozePickScreen, MarkAllCategory, MarkAllScreen, MarkWordScreen, McqScreen, PassageMcqScreen, PassageQuizQuestion, PassageQuizScreen (+11 more)
...
Cohesion: 0.06
Nodes (25): c1Lessons, c2Lessons, c3Lessons, clone(), EditModel, screenList(), SECTION_IDS, i() (+17 more)
...
Cohesion: 0.18
Nodes (6): EditStore, hashString(), ICONS, lessonIcon(), PALETTE, SectionTheme

### Community 99 - "MarkAll.svelte"
Cohesion: 0.47
Nodes (4): cat(), MARK_ALL_DEFAULT, MARK_ALL_PALETTE, markAllSwatch

## Knowledge Gaps
- **548 isolated node(s):** `Entities`, `Files (`front/src/lib/content/`)`, `Rules`, `Screen taxonomy (the `type` discriminator)`, `Runtime state (separate from content)` (+543 more)
