...
## Corpus Check
- 226 files · ~228,779 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1198 nodes · 1471 edges · 177 communities (159 shown, 18 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 31 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4a0c0f05`
...
Cohesion: 0.07
Nodes (24): baseScreens, canRecapPreface, currentPath, currentScreen, direction, editHref, footerDisabled, footerLabel (+16 more)
...
Cohesion: 0.16
Nodes (7): SECTION_IDS, i(), SCREEN_TYPE_GROUPS, SCREEN_TYPES, issuesByNode(), getLessonsBySection(), oi()
