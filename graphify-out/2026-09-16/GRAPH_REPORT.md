...
## Corpus Check
- 147 files · ~118,565 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1047 nodes · 1343 edges · 96 communities (79 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `676c6adb`
...
## Knowledge Gaps
- **542 isolated node(s):** `mission`, `workflow`, `persona`, `graphify`, `MarkAllCategory` (+537 more)
