...
## Corpus Check
- 142 files · ~112,006 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1018 nodes · 1263 edges · 95 communities (79 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `471e6bc8`
...
Cohesion: 0.09
Nodes (21): TYPE_HE, LessonScreen, MarkAllCategory, MarkAllScreen, MarkWordScreen, McqScreen, PassageMcqScreen, PassageQuizQuestion (+13 more)
...
Cohesion: 0.06
Nodes (14): clone(), EditModel, screenList(), SECTION_IDS, i(), ScreenPath, blankScreen(), SCREEN_TYPE_GROUPS (+6 more)
...
Cohesion: 0.05
Nodes (23): post(), saveLessonContent(), saveSection(), storedKey(), errorCount, hint, issues, issuesFor (+15 more)
...
Cohesion: 0.13
Nodes (22): c1Lessons, c2Lessons, c3Lessons, getGithubFile(), ghHeaders(), putGithubFile(), repoUrl(), all (+14 more)
...
### Community 89 - "MarkAll.svelte"
Cohesion: 0.18
Nodes (3): cat(), KEY, LessonSession
...
## Knowledge Gaps
- **537 isolated node(s):** `MarkAllCategory`, `MarkAllScreen`, `MarkWordScreen`, `McqScreen`, `PassageMcqScreen` (+532 more)
