...
## Corpus Check
- 213 files · ~203,074 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1102 nodes · 1309 edges · 171 communities (151 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `813a2ffa`
...
Cohesion: 0.13
Nodes (14): post(), saveLessonContent(), saveSection(), storedKey(), errorCount, hint, issues, issuesFor (+6 more)
...
Cohesion: 0.08
Nodes (19): c1Lessons, c2Lessons, c3Lessons, clone(), EditModel, screenList(), SECTION_IDS, ScreenPath (+11 more)
...
### Community 94 - "[moduleId]/+layout.ts"
Cohesion: 0.50
Nodes (3): getModule(), load(), ./$types

### Community 96 - "activeField.svelte.ts"
Cohesion: 0.10
Nodes (27): ActiveField, ActiveLine, currentBlock(), formatAlign(), formatBold(), formatCode(), formatColor(), formatDirection() (+19 more)
