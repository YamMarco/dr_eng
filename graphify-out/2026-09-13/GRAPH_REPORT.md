...
## Corpus Check
- 142 files · ~111,457 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1026 nodes · 1301 edges · 101 communities (82 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d90f964a`
...
Cohesion: 0.16
Nodes (11): CurriculumModule, CurriculumSection, getModule(), modules, textSection, UnitGroup, unitGroups, wordsSection (+3 more)
...
Cohesion: 0.06
Nodes (26): c1Lessons, c2Lessons, c3Lessons, clone(), EditModel, screenList(), SECTION_IDS, i() (+18 more)
...
### Community 95 - "[unitId]/+layout.ts"
Cohesion: 0.50
Nodes (3): getUnitGroup(), load(), ./$types

### Community 96 - "activeField.svelte.ts"
Cohesion: 0.16
Nodes (20): ActiveField, currentBlock(), formatAlign(), formatBold(), formatCode(), formatColor(), formatDirection(), formatHeader() (+12 more)
...
## Knowledge Gaps
- **533 isolated node(s):** `gitignorePath`, `name`, `private`, `version`, `type` (+528 more)
