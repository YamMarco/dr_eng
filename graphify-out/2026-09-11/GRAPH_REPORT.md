...
## Corpus Check
- 143 files · ~105,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 992 nodes · 1204 edges · 94 communities (75 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea0f4be4`
...
## Knowledge Gaps
- **534 isolated node(s):** `Issue`, `MarkAllSegment`, `MarkAllCategory`, `MarkAllScreen`, `MarkWordScreen` (+529 more)
