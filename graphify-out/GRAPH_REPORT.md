...
## Corpus Check
- 127 files · ~94,923 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 883 nodes · 1041 edges · 83 communities (66 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `da736b11`
...
5. `/graphify` - 10 edges
6. `Lesson structure — quick reference` - 9 edges
7. `scripts` - 9 edges
...
Cohesion: 0.08
Nodes (20): allScreenPaths, allScreens, currentLocation, currentPath, currentScreen, dirty, editSheetOpen, footerDisabled (+12 more)
...
Cohesion: 0.09
Nodes (22): SCREEN_TYPE_GROUPS, SCREEN_TYPES, LessonScreen, MarkAllCategory, MarkAllScreen, MarkWordScreen, McqScreen, PassageMcqScreen (+14 more)

### Community 36 - "content/index.ts"
Cohesion: 0.13
Nodes (20): c1Lessons, c2Lessons, c3Lessons, getGithubFile(), ghHeaders(), putGithubFile(), repoUrl(), all (+12 more)
...
### Community 68 - "imporve.md"
Cohesion: 0.40
Nodes (4): changes, l03:, notes for later, rules

### Community 69 - "lessons/+page.svelte"
Cohesion: 0.18
...
## Knowledge Gaps
- **497 isolated node(s):** `MarkAllCategory`, `MarkAllScreen`, `MarkWordScreen`, `McqScreen`, `PassageMcqScreen` (+492 more)
