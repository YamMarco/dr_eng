...
## Corpus Check
- 142 files · ~116,068 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1018 nodes · 1291 edges · 98 communities (82 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7561b81`
...
Cohesion: 0.17
Nodes (8): screenList(), ScreenPath, blankScreen(), SCREEN_TYPE_GROUPS, SCREEN_TYPES, TYPE_HE, LessonRound, LessonScreen
...
### Community 84 - "lessonProgress.svelte.ts"
Cohesion: 0.29
...
### Community 95 - "markAllColors.ts"
Cohesion: 0.67
Nodes (3): MARK_ALL_DEFAULT, MARK_ALL_PALETTE, markAllSwatch
...
## Knowledge Gaps
- **535 isolated node(s):** `gitignorePath`, `name`, `private`, `version`, `type` (+530 more)
