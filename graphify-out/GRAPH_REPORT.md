...
## Corpus Check
- 92 files · ~42,024 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 430 nodes · 527 edges · 36 communities (22 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16d54011`
...
Cohesion: 0.07
Nodes (29): McqScreen, markTargets(), archivedEyeCatchersSection, archivedMockSection2, archivedMockSection3, contentBySection, Lesson, s3Lessons (+21 more)
...
Cohesion: 0.05
Nodes (30): screenComponents, KEY, LessonScore, recordAnswer(), KEY, LessonSession, LessonScreen, MarkAllScreen (+22 more)

### Community 35 - "index.svelte.ts"
Cohesion: 0.07
Nodes (12): dictionaries, I18n, Language, ar, Dictionary, DictionaryOverride, he, PALETTE (+4 more)

## Knowledge Gaps
- **199 isolated node(s):** `guide`, `message/the point:`, `questions:`, `material:`, `message/the point:` (+194 more)
...
- **What connects `guide`, `message/the point:`, `questions:` to the rest of the system?**
