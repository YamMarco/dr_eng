# Graph Report - dr_eng  (2026-09-15)

## Corpus Check
- 143 files · ~116,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1026 nodes · 1300 edges · 100 communities (80 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `649055a1`
...
Cohesion: 0.06
Nodes (22): c1Lessons, c2Lessons, c3Lessons, clone(), EditModel, screenList(), SECTION_IDS, i() (+14 more)
...
Cohesion: 0.24
Nodes (5): cat(), MARK_ALL_DEFAULT, MARK_ALL_PALETTE, markAllSwatch, MarkAllSegment

### Community 100 - "lessonIcon.ts"
Cohesion: 0.67
Nodes (3): hashString(), ICONS, lessonIcon()

## Knowledge Gaps
- **537 isolated node(s):** `ICONS`, `gitignorePath`, `name`, `private`, `version` (+532 more)
...
- **What connects `ICONS`, `gitignorePath`, `name` to the rest of the system?**
