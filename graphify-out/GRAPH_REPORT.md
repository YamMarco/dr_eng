...
## Corpus Check
- 143 files · ~104,778 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 992 nodes · 1203 edges · 94 communities (75 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `04461e6f`
...
Cohesion: 0.48
Nodes (6): ActiveField, formatBold(), formatCode(), formatItalic(), formatLink(), withActive()
...
## Knowledge Gaps
- **534 isolated node(s):** `ActiveField`, `Issue`, `MarkAllSegment`, `MarkAllCategory`, `MarkAllScreen` (+529 more)
...
- **What connects `ActiveField`, `Issue`, `MarkAllSegment` to the rest of the system?**
