...
Cohesion: 0.08
Nodes (25): c1Lessons, c2Lessons, c3Lessons, post(), saveLessonContent(), saveSection(), storedKey(), errorCount (+17 more)
...
## Knowledge Gaps
- **531 isolated node(s):** `selectedId`, `canvasHeight`, `bands`, `SECTION_IDS`, `ActiveField` (+526 more)
