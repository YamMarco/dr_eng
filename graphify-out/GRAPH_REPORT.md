...
## Corpus Check
- 79 files · ~26,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 339 nodes · 388 edges · 34 communities (20 shown, 14 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9370e937`
...
Cohesion: 0.09
Nodes (8): DebugStore, dictionaries, I18n, Language, ar, Dictionary, DictionaryOverride, he
...
## Knowledge Gaps
- **161 isolated node(s):** `mission`, `workflow`, `persona`, `graphify`, `LessonPart` (+156 more)
