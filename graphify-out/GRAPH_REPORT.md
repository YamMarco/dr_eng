...
6. `scripts` - 9 edges
7. `Section 2 · P1 — לא קוראים את הטקסט` - 9 edges
8. `Section 17 · בנק מילים · חברה וקהילה` - 9 edges
9. `Section 21 · מקשרים ומרפאת שגיאות` - 9 edges
...
Cohesion: 0.05
Nodes (36): markTargets(), archivedEyeCatchersSection, archivedMockSection2, archivedMockSection3, contentBySection, Lesson, markNegContrast(), NEG_CONTRAST (+28 more)
...
Cohesion: 0.11
Nodes (15): MarkAllScreen, MarkWordScreen, PassageQuizQuestion, PassageQuizScreen, PrefaceScreen, QuestionPreviewScreen, SpellWordScreen, StepsScreen (+7 more)
...
### Community 42 - "WritingTask.svelte"
Cohesion: 0.20
...
### Community 54 - "חלק ה׳ — סקשנים 17–26: אוצר מילים, כתיבה, זמן, סימולציה"
Cohesion: 0.29
...
### Community 63 - "vocabLesson.ts"
Cohesion: 0.40
Nodes (5): LessonScreen, McqScreen, placed(), vocabRounds(), VocabWord

## Knowledge Gaps
- **406 isolated node(s):** `gitignorePath`, `name`, `private`, `version`, `type` (+401 more)
