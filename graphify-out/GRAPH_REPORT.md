...
## Corpus Check
- 135 files · ~100,735 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 920 nodes · 1125 edges · 89 communities (69 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `86a920b5`
...
### Community 38 - "api.ts"
Cohesion: 0.19
Nodes (5): post(), saveLessonContent(), saveSection(), storedKey(), EditStore

### Community 39 - "he.ts"
Cohesion: 0.40
Nodes (4): ar, Dictionary, DictionaryOverride, he
...
Cohesion: 0.06
Nodes (13): clone(), EditModel, screenList(), i(), ScreenPath, blankScreen(), SCREEN_TYPE_GROUPS, SCREEN_TYPES (+5 more)
...
## Knowledge Gaps
- **493 isolated node(s):** `Issue`, `MarkAllSegment`, `MarkAllCategory`, `MarkAllScreen`, `MarkWordScreen` (+488 more)
