...
Cohesion: 0.18
Nodes (10): imports, isBigNode(), OUT, sectionFileNames, sectionMeta, spread, TEACHING, countQuestions() (+2 more)
...
## Knowledge Gaps
- **397 isolated node(s):** `Entities`, `Files (`front/src/lib/content/`)`, `Rules`, `Screen taxonomy (the `type` discriminator)`, `Runtime state (separate from content)` (+392 more)
