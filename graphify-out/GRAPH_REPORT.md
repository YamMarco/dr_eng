...
## Corpus Check
- 135 files · ~100,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 924 nodes · 1129 edges · 88 communities (70 shown, 18 thin omitted)
...
Cohesion: 0.08
Nodes (10): clone(), EditModel, screenList(), i(), ScreenPath, blankScreen(), SCREEN_TYPE_GROUPS, SCREEN_TYPES (+2 more)
...
Cohesion: 0.05
Nodes (22): DebugStore, currentPath, currentScreen, editHref, footerDisabled, footerLabel, isLastScreen, justFinished (+14 more)
...
## Knowledge Gaps
- **492 isolated node(s):** `selectedId`, `canvasHeight`, `Layout`, `Model & save`, `Local dev vs. production` (+487 more)
...
- **What connects `selectedId`, `canvasHeight`, `Layout` to the rest of the system?**
