...
## Corpus Check
- 262 files · ~496,227 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1422 nodes · 1985 edges · 200 communities (163 shown, 37 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1a2bf4c1`
...
Cohesion: 0.13
Nodes (15): @capacitor/cli, eslint-plugin-svelte, devDependencies, @capacitor/cli, eslint-plugin-svelte, globals, prettier-plugin-svelte, @sveltejs/adapter-auto (+7 more)
...
### Community 91 - "EditWorkspace.svelte"
Cohesion: 0.17
...
## Knowledge Gaps
- **649 isolated node(s):** `gitignorePath`, `name`, `private`, `version`, `type` (+644 more)
...
- **Why does `LessonScreen` connect `ExamEditModel` to `SlideStage.svelte`, `lesson-screens/types.ts`, `EditModel`, `registry.ts`, `validate.ts`?**
