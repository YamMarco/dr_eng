...
## Corpus Check
- 190 files · ~407,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1322 nodes · 1921 edges · 118 communities (86 shown, 32 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fd41a59b`
...
Cohesion: 0.06
Nodes (20): LessonBucket, Bucket, EditModelLike, clone(), ExamEditModel, onMove(), onUp(), ScreenPath (+12 more)
...
## Knowledge Gaps
- **640 isolated node(s):** `SectionTheme`, `ProgressMap`, `ThemeMode`, `PageState`, `AssortedQuiz` (+635 more)
...
- **Why does `LessonScreen` connect `ExamEditModel` to `SlideStage.svelte`, `QuizRunner.svelte`, `lesson-screens/types.ts`, `EditModel`, `registry.ts`, `validate.ts`?**
...
- **What connects `SectionTheme`, `ProgressMap`, `ThemeMode` to the rest of the system?**
