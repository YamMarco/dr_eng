...
Cohesion: 0.09
Nodes (27): ActiveField, currentBlock(), formatAlign(), formatBold(), formatCode(), formatColor(), formatDirection(), formatHeader() (+19 more)
...
## Knowledge Gaps
- **533 isolated node(s):** `Model`, `Where things live (`front/src/`)`, `Authoring a lesson`, `Screen types`, `Text formatting syntax` (+528 more)
