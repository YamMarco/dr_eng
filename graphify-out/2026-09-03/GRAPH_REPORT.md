# Graph Report - dr_eng  (2026-09-03)

## Corpus Check
- 103 files · ~70,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 689 nodes · 827 edges · 60 communities (47 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `752c0cb4`
...
Cohesion: 0.15
Nodes (9): programContent, archivedContentBySection, archivedEyeCatchersSection, archivedMockSection2, archivedMockSection3, s4Opener, s5Opener, SectionIntro (+1 more)
...
Cohesion: 0.22
Nodes (8): Content sourcing (composition, not new entities), Entities, Lesson & content — data model, Notes for the architect, Relationships & rules, Runtime state (separate from content), Screen taxonomy (the `type` discriminator), Type sketch

### Community 38 - "חלק א׳ — עקרונות התוכנית"
Cohesion: 0.25
...
### Community 41 - "חלק ד׳ — סקשנים 10–16: סוגי השאלות"
Cohesion: 0.29
...
Cohesion: 0.17
Nodes (14): authored, place(), placeLesson(), ProgramLesson, ProgramSection, programSectionMeta, sections, trackColumns() (+6 more)
...
## Knowledge Gaps
- **396 isolated node(s):** `Entities`, `Screen taxonomy (the `type` discriminator)`, `Relationships & rules`, `Content sourcing (composition, not new entities)`, `Runtime state (separate from content)` (+391 more)
...
- **Why does `חלק ה׳ — סקשנים 17–26: אוצר מילים, כתיבה, זמן, סימולציה` connect `חלק ה׳ — סקשנים 17–26: אוצר מילים, כתיבה, זמן, סימולציה` to `Section 20 · משפטים שעובדים`, `חלק ד׳ — סקשנים 10–16: סוגי השאלות`, `Section 17 · בנק מילים · חברה וקהילה`, `Section 21 · מקשרים ומרפאת שגיאות`, `Section 18 · בנק מילים · טכנולוגיה, סביבה ו-collocations`, `Section 22 · ניהול זמן`, `Section 23 · YES או NO`, `Section 24 · סיבה, הסבר, דוגמה`, `Section 25 · בנק הדוגמאות ואורך התשובה`, `Section 26 · סימולציה ותיקון`?**
...
- **What connects `Entities`, `Screen taxonomy (the `type` discriminator)`, `Relationships & rules` to the rest of the system?**
