...
Cohesion: 0.07
Nodes (30): LessonScreen, McqScreen, markTargets(), archivedEyeCatchersSection, archivedMockSection2, archivedMockSection3, contentBySection, Lesson (+22 more)
...
## Knowledge Gaps
- **199 isolated node(s):** `gitignorePath`, `name`, `private`, `version`, `type` (+194 more)
