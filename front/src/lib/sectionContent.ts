...
// question is really built around. 4.c.1.1 is the module-wide "before we
// start" message (see git history / getModulePreface for the previous
// synthetic-node approach — it's now just this section's first lesson).
// 4.c.1.2 and 4.c.1.3 are copies of archivedSectionOneContent.lessons[0]
// and [1] (edited copies, not references — the archive stays untouched).
// Lesson 4+ is still a mockup placeholder until that content is written.
