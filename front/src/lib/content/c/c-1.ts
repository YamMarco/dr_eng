  ...
  },
  {
    ...
    content: {
      preface: [
        {
          type: "preface",
          text: "\nעד עכשיו למדנו מה עושים **לפני שמחפשים תשובה**:\n\nקודם מבינים על מה הטקסט מדבר, ואז בודקים שאנחנו מבינים את השאלה( פה היית רוצה להוסיף משהו ויזואלי כמו טקטס ואז הכותרת והפסקה הראשונה מודגשים). \n\nעכשיו עוברים לשלב הבא: **איך מחפשים את התשובה בפסקאות של הטקסט.**",
        },
        {
          type: "preface",
          text: "**מהי מילת מפתח?**\n\nמילת מפתח היא מילה שעוזרת לנו לדעת **מה לחפש בטקסט**. המטרה של מילת המפתח היא פשוטה: במקום לקרוא שוב את כל הפסקה, אנחנו מחפשים את המילה החשובה — וכך מגיעים מהר יותר לאזור שבו נמצאת התשובה. בדרך כלל זו מילה חשובה מתוך השאלה — למשל:\n\n             **++ אדם-מקום-דבר-רעיון- פעולה מרכזית++**\n\nמילות שאלה כמו **++what, why, how, when++** לא עוזרות לנו למצוא את המקום בטקסט. הן אומרות לנו **איזה סוג תשובה צריך לתת**++, אבל לא איפה לחפש++.\n\n{a:right}למשל:\n{a:right}\n{a:center}**Why did the scientists start the project?**\n\n{a:center}**Why** אומר לנו שאנחנו צריכים למצוא **סיבה**.\n\n**אבל** המילים שעוזרות לנו למצוא את המקום בטקסט הן:\n{a:center}**scientists------ ****project**\n\n++**אלה המילים שנחפש בטקסט, או מילים דומות להן.**++\n\n",
        },
        {
          type: "preface",
