...
export const c1Lessons: LessonNode[] = [
  {
    ...
    content: {
      preface: [
        {
          type: "preface",
          text: 'תרגלנו מילים ועברתם בהצלחה! ולעכשיו הנה לכם סיפור שמתרחש לפחות 3 פעמים בכל מחצית: יש לכם את קבוצת הוואטסאפ לאנגלית שיש בה 500 הודעות לפחות. וכמובן שיש תמיד את החבר ההוא ששואל: "נו, מתי הבחינה? מה החומר?"\n\nבמקרה זה, האם אתם גוללים 500 הודעות מההתחלה כדי למצוא את התשובה? בטח שלא!\n\nפשוט לוחצים על 🔍 ומחפשים מילה אחת. תוך שנייה - אתם שם, ואז אתם מקפיצים לו את התשובה. חסכתם לעצמכם זמן ומאמץ מיותר, בלי אפילו לחשוב על זה.',
        },
        {
          type: "preface",
