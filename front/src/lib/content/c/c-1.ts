  ...
  },
  {
    ...
    content: {
      preface: [
        ...
        {
          type: "preface",
          text: "שיטת הרמזור\n\nמהיום, כל שאלה מקבלת צבע:\n\n🟢 **ירוק - אני מבין את השאלה.**\nאני יודע להסביר בעברית מה רוצים ממני. מתקדמים ומחפשים את התשובה.\n\n🟡 **צהוב - אני מבין את רוב השאלה.**\nחסרה לי מילה או שתיים. **אסור לנחש.** קודם מילון (עד 30 שניות).\n\n🔴 **אדום - אני לא מצליח להסביר מה רוצים.**\nעוצרים. לא קוראים שוב את הטקסט ולא מנחשים. מפרקים את השאלה לחלקים, ורק אז מילון למה שנשאר.",
        },
        {
          type: "preface",
