        ...
        },
        {
          screens: [
            ...
            },
            {
              ...
              correctIndex: 0,
              explanation:
                '"what do we learn" = מה לומדים · "paragraph III" = רק פסקה III.',
            },
            {
              type: "mcq",
              prompt:
              ...
              options: [
                "אחת",
                "שתיים",
                "שלוש - according to · paragraph II · explain",
                "אף אחת",
              ],
              correctIndex: 2,
        ...
        },
        {
          screens: [
            ...
            },
            {
              ...
              correctIndex: 1,
              explanation:
                "according to paragraph I = פסקה I בלבד. give ONE reason = סיבה אחת.",
            },
            {
              type: "self-check",
              prompt:
        ...
        },
        {
          screens: [
            ...
            },
            {
              type: "mark-all",
              instruction:
                'סמנו כל Eye Catcher - ניגוד, הגבלה, מספרים, שמות, "in addition"',
            ...
            },
            {
              type: "mcq",
              prompt:
                '"In addition, in Kenya, rivers began to flow again." - מה זה מסמן?',
              options: ["שזה הסיכום", "שתשובה שנייה מגיעה", "שזו פנייה בסיפור"],
              correctIndex: 1,
              explanation:
                '"In addition" = עוד מידע. בשאלת TWO answers - כאן יושבת התשובה השנייה.',
            },
            {
              type: "self-check",
        ...
        },
        {
          screens: [
            ...
            },
            {
              type: "self-check",
              prompt:
                "הסבירו: למה Eye Catchers עוזרים דווקא לתלמיד עם אנגלית חלשה?",
              modelAnswer:
        ...
        },
        {
          screens: [
            { type: "preface", text: "YOUR TURN - השלימו את המילה החסרה." },
            {
              type: "mcq",
              prompt:
                "The scientists wanted to ______ the forests from destruction.",
            ...
            },
            {
              ...
              title: "ONE SENTENCE",
              lines: [
                '"environment, volunteer, result - אני מזהה ועובר הלאה."',
              ],
            },
          ],
        },
        {
          screens: [
            ...
            },
            {
              ...
              correctIndex: 1,
              explanation:
                "שקר. residents = תושבים · researchers = חוקרים. לא לבלבל.",
            },
          ],
        },
        {
          screens: [
            ...
            },
            {
              type: "mcq",
              prompt:
                '"The project could reduce carbon in the atmosphere." - מה זה reduce?',
        ...
        },
        {
          screens: [
            ...
            },
            {
              ...
              modelAnswer:
                "Volunteering can improve my English and my social skills.",
            },
            {
              type: "self-check",
            ...
            },
            {
              ...
              title: "ONE SENTENCE",
              lines: [
                '"improve, affect, skill - אני מזהה, וגם משתמש בהם בכתיבה."',
              ],
            },
          ],
        },
        ...
        },
        {
          screens: [
            ...
            },
            {
              type: "mcq",
              prompt:
                '"Students became more responsible." - מאיזה טקסט בקורס זה?',
              options: [
                "הטקסט על שחייה",
              ...
              correctIndex: 2,
              explanation:
                'פסקה III: "students became more responsible and more focused in class."',
            },
            {
              type: "mark-all",
