...
// Real Module C practice exam ("module_c_exam3_animals.json"), replacing the
// placeholder quiz content. Paragraph refs (I-IV) match the source exam's own
// paragraph ids, which line up with PassageBody's auto-assigned roman labels
// since both are in reading order.
export const cExam3Animals: QuizNode = {
	id: 'module-c-exam-3',
	module: 'c',
	...
	parts: [
		{
			...
			screens: [
				...
				},
				{
					type: 'mcq',
					paragraphRef: 'III',
					prompt: 'According to paragraph III, what do scientists say about animals that feel lonely?',
					options: [
				...
				},
				{
					type: 'writing-task',
					paragraphRef: 'IV',
					prompt: 'According to paragraph IV, what do some animal shelters do to help lonely animals?',
					points: 8
				},
				{
					type: 'mcq',
					paragraphRef: 'IV',
					prompt: 'According to paragraph IV, how do people feel when they see these unusual friendships?',
					options: [
